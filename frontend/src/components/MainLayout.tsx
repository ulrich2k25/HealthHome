...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  // 🔹 Liste des pages publiques (pas de sidebar ici)
  ...
  // ============================================================
  // 🔸 Affichage principal (layout complet)
  // ============================================================
  return (
    <div className={`min-h-screen ${!hideSidebar ? "grid grid-cols-[240px_1fr]" : ""}`}>
      {!hideSidebar && (
        <aside className="flex flex-col justify-between bg-white border-r border-gray-300 p-5 text-gray-800 relative">
          {/* --- Haut : menu de navigation --- */}
          <div>
            ...
            <nav className="space-y-2">
              ...
              <Link href="/termin" className="block px-3 py-2 rounded-md hover:bg-gray-200">
                Termine
              </Link>
              <Link href="/impfungen" className="block px-3 py-2 rounded-md hover:bg-gray-200">
                Impfungen
              </Link>
              <Link href="/medikamente" className="block px-3 py-2 rounded-md hover:bg-gray-200">
                Medikamente
              </Link>
              <Link href="/mahlzeit" className="block px-3 py-2 rounded-md hover:bg-gray-200">
                Mahlzeit
              </Link>
            </nav>
          </div>
          ...
          {/* --- MODAL EXPORT --- */}
          {showExportBox && (
            <div className="absolute bottom-24 left-5 right-5 bg-white border border-gray-300 rounded-lg shadow-lg p-4 animate-fade-in">
